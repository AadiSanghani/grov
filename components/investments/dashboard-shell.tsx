...
import type { InvestmentDashboardData, InvestmentTimeRange, InvestmentTransaction } from '@/lib/investments/types'
...
export function InvestmentsDashboardShell() {
  ...
  return (
    <>
      ...
      <InvestmentsHoldingsTable holdings={data.holdings} />
